    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <section class="col-sm-6 col-sm-offset-3 well">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <button class="btn btn-warning btn-block" type="submit">Voir les règles de compositions <span
                                class="glyphicon
                ...
                <article class="panel panel-warning">
                    ...
                    <div class="panel-body">
                        <ul>
                            <li>Tout étudiant, avant de composer doit créer un compte en s'inscrivant ou se connecter à
                                son compte déja créé.</li><br>
                            <li>Avant toute composition il faut s'enregistrer pour la matière dans votre compte sur la
                                page <em>Gérer mes matières</em>.</li><br>
                            <li>Toute matière choisie pour être composée ne peut être supprimmée après l'heure de
                                démarrage de la dite composition.</li><br>
                            <li>Toute soumission de réponses à une composition après l'heure de fin de cette dèrniere
                                est considérée comme nulle et la dite matière manquée.</li><br>
                            <li>Le résultat pour une composition n'est consultable qu'après l'heure de fin de la matière
                                depuis la page <em>Mes matières</em>.</li><br>
                        </ul>
                    </div>
                </article>
            </section>
