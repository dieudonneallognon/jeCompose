		...
		<?php
			...
			echo "<script>
				...
				for ($i=1; $i <= 10; $i++)
				{
					...
					else if (isset($eRep[$i]) && $eRep[$i] != $vRep[$i]) {
			...
			if ($donnees = $rep->fetch())
			{
				...
				else if($donnees['note'] >= 16 && $donnees['note'] <= 17)
				{
				...
				else if($donnees['note'] >= 14 && $donnees['note'] <= 15)
				{
				...
				else if ($donnees['note'] >= 12 && $donnees['note'] <= 13)
				{
